...
* **Class A:** رنج 0 تا 127. اولین 8 بیت برای NetID و 24 بیت بعدی برای HostID است.

* **Class B:** رنج 128 تا 191. اولین 16 بیت برای NetID و 16 بیت بعدی برای HostID است.

* **Class C:** رنج 192 تا 223. اولین 24 بیت برای NetID و 8 بیت بعدی برای HostID است.

* **Class D:** رنج 224 تا 239، برای ارتباطات چندپخشی (Multicast) به کار می‌روند.

* **Class E:** رنج 240 تا 255، رزرو شده و برای مقاصد تحقیقاتی و آزمایش پروتکل‌های جدید مورد استفاده قرار می‌گیرند.
